      ...
      <div className="header-cou">
        ...
        <div className="grid">
          ...
          <div className="updates">
            ...
            <p>
              Focuses on puzzles, seating arrangement, coding-decoding,
              syllogism, and analytical reasoning. Helps improve problem-solving
              speed.
            </p>
          </div>
          <div className="updates">
      ...
      <div className="cou">
        ...
        <div className="grids">
          ...
          <div className="updates">
            ...
            <p>
              Includes general science topics, recent technological
              advancements, space research, and biotechnology.
            </p>
          </div>
        </div>
      </div>
